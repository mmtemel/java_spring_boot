...
//Repository anotasyonu ile Spring container bu sınıftan çalışma zamanında
//bir bean oluşturur.Bu bean'i de çalışma zamanında petclinic service bean'i
//içerisine enjecte edeceğiz.
@Repository
